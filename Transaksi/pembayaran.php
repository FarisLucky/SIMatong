    ...
    <div class="container">
        <div class="row">
            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <!-- <div class="hello"> -->
                <div class="col-md-4">
                    <a href="<?= $url_login ?>akun/rekening.php" class="btn btn-sm btn-info mt-2"><i class="fa fa-plus-circle"></i>&nbspKelola Rekening </a>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-7">
                        <select name="rek" id="rekening" class="form-control-sm form-control">
                        <?php
                        ...
                        ?>
                            ...
                            foreach ($reks as $rek) {
                            ?>
                                <option value="<?php echo $rek['id_rekening'] ?>"><?php echo $rek["no_rekening"] ?></option>
                            <?php    
                            }
                            ?>
                        </select>
            ...
            <div class="alert alert-warning alert-dismissible fade show mt-4" role="alert">
                <strong>Jika Belum ada Rekening,</strong> Klik tombol <strong>kelola akun rekening</strong> atau untuk mengelola rekening anda yang akan di gunakan untuk pembayaran
